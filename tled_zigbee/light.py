...
class Light():
  def __init__(self, address, endpoint, controller, is_group=False, read_timeout = 3):
  ...
  def off(self, print_return=False, seconds_before_next_command=2):
    if time.time() - self.last_controlled_time > seconds_before_next_command:
      self.state = 0
